...
class Goal(db.Model):
    ...
    child_goal_id = db.Column(db.Integer, db.ForeignKey('goals.id'), nullable=True)
    ...
    users = db.relationship('User', secondary='goal_shares', backref='shared_goals', lazy=True)
